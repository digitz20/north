...
import {
  ...
  Telegram, Email, Phone, LocationOn, Apple, Google, ChevronRight,
          ...
          <Grid container spacing={8}>
             <Grid item xs={12} md={4}>
               ...
               <Box sx={{ display: 'flex', gap: 2 }}>
                 {[
                   { icon: <Twitter />, url: 'https://x.com/northcrestbhc?s=11&t=S9yZdFAj7Jgd3OUnk9aKKw' },
                   { icon: <Telegram />, url: 'https://t.me/northcrestbhc' },
                   { icon: <Instagram />, url: 'https://www.instagram.com/northcrestbhc?igsh=aGsyN3F3MnJ3M2pt&utm_source=qr' },
                   { icon: <Facebook />, url: 'https://www.facebook.com/share/1BA3QAUStT/?mibextid=wwXIfr' },
                   { 
                     icon: (
                   ...
                   <IconButton 
                     ...
                     sx={{ color: 'rgba(255,255,255,0.6)', '&:hover': { color: 'white', background: 'rgba(255,255,255,0.1)' } }}
                   >
                     {item.icon}
                   </IconButton>
                 ))}
