                ...
                <Paper sx={{ 
                  ...
                  <Box sx={{ 
                    ...
                    <Box sx={{ 
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 600, fontSize: { xs: '0.75rem', sm: '0.875rem' }, wordBreak: 'break-all' }}>{transactionId}</Typography>
                    </Box>
                    <Box sx={{ 
                      display: 'flex', 
                      flexDirection: { xs: 'column', sm: 'row' },
                    ...
                    <Box sx={{ 
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 700, color: '#0066FF', fontSize: { xs: '0.875rem', sm: '0.875rem' } }}>${parseFloat(transferForm.amount).toLocaleString()}</Typography>
                    </Box>
                    <Box sx={{ 
                      display: 'flex', 
                      flexDirection: { xs: 'column', sm: 'row' },
                      ...
                      <Typography variant="body2" color="text.secondary" sx={{ fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>Method</Typography>
                      <Typography variant="body2" sx={{ fontWeight: 600, fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>{selectedMethod?.name}</Typography>
                    </Box>
                    <Box sx={{ 
                      display: 'flex', 
                      flexDirection: { xs: 'column', sm: 'row' },
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 600, fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>{transferForm.recipientName}</Typography>
                    </Box>
                    <Box sx={{ 
                      display: 'flex', 
                      flexDirection: { xs: 'column', sm: 'row' },
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 600, fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>{transferForm.recipientBankDetails.accountNumber}</Typography>
                    </Box>
                    <Box sx={{ 
                      display: 'flex', 
                      flexDirection: { xs: 'column', sm: 'row' },
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 600, fontSize: { xs: '0.75rem', sm: '0.875rem' }, wordBreak: 'break-word' }}>{transferForm.recipientBankDetails.bankName}</Typography>
                    </Box>
                    <Box sx={{ 
                      display: 'flex', 
                      flexDirection: { xs: 'column', sm: 'row' },
